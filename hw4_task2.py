...
# ]
# import pathlib to get the current script directory
import pathlib


def get_cats_info(path):
    cats_list = []  # initialize empty list to hold cats info
    ...
    try:
        ...
        with open(current_dir / path, "r", encoding="utf-8") as fh:
            for line in fh:
                # split each line by comma to get id, name and age
                cat_id, name, age = line.strip().split(",")
                # create a dictionary for each cat and append to the list
